        ...
        <html>
          ...
          <body>
            <div class="header">
              ...
              <div>Generated on ${new Date(letter.created_at).toLocaleDateString()}</div>
            </div>
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">{letter?.title}</h1>
            <p className="text-gray-500 mt-1">Created on {new Date(letter?.created_at).toLocaleDateString()}</p>
          </div>
          <button
        ...
        <div className="mt-6 flex gap-3 justify-center sm:justify-start">
          <button
            ...
            className="py-2 px-6 bg-primary text-white rounded-lg font-semibold hover:bg-primary-700 transition"
          >
            ✎ Edit Letter
          </button>
          <button
