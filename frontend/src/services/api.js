...
export const cvAPI = {
  ...
  generateSummary: (cvId, jobDescription = '') =>
    apiClient.post(`/cvs/${cvId}/generate-summary`, { job_description: jobDescription }),

  improveBullets: (cvId, data) =>
    apiClient.post(`/cvs/${cvId}/improve-bullets`, data),
