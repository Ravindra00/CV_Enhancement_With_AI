    ...
    try:
        ...
        if skills:
            if isinstance(skills, list):
                # If skills is list of dicts: [{"name": "Python", ...}]
                skill_names = [
                    s.get('name', str(s)) if isinstance(s, dict) else str(s)
                    for s in skills
                ]
                skills_text = ", ".join(skill_names[:10])  # Top 10
            else:
        ...
        if experiences and isinstance(experiences, list) and len(experiences) > 0:
            exp = experiences[0]  # Most recent job
...
I am writing to express my strong interest in the position outlined in your job description. With my professional background and skills, I am confident that I can contribute meaningfully to your team.

My experience has equipped me with a comprehensive understanding of the key responsibilities you're seeking. I am particularly drawn to this opportunity because of your organization's commitment to excellence and innovation. I am excited about the prospect of bringing my expertise to your company and growing together.

I would welcome the opportunity to discuss how my background aligns with your team's needs. Thank you for considering my application, and I look forward to hearing from you.
